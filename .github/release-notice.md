...
>
> The app is not damaged. It carries no paid certificate, and this is what
> macOS and Windows show for one. Do this once and it opens normally from then
> on.
>
...
> ### 初回起動時に開けないとき
>
> アプリケーションは壊れていません. 有料の証明書を付けていないだけで, macOS も
> Windows もそういうアプリにこの表示を出します. 一度だけ下の操作をすれば, 次からは
> 普通に開きます.
>
